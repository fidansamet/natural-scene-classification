...
class Options:
    def initialize(self, parser):
        ...
        # train
        parser.add_argument('-model_name', type=str, default='sl_nn_', help='name of the model to save')
        parser.add_argument('-hidden_layer_num', type=int, default=1, help='number of hidden layers')
        parser.add_argument('-hidden_unit_num', type=int, default=1, help='number of hidden units in hidden layers')
        ...
        parser.add_argument('-activation_func', type=str, default='sigmoid', help='sigmoid | tanh| relu')
